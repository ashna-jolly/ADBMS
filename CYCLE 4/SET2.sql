...
ALTER TABLE CUSTOMER2 ADD PRIMARY KEY (CID);

ALTER TABLE ACCOUNTS ADD FOREIGN KEY (BID) REFERENCES BRANCH(BID);
ALTER TABLE DEPOSITOR1 ADD FOREIGN KEY (CID) REFERENCES CUSTOMER2(CID);
ALTER TABLE DEPOSITOR1 ADD FOREIGN KEY (ACCNO) REFERENCES ACCOUNTS(ACCNO);
...
INSERT INTO DEPOSITOR1(CID,ACCNO) VALUES
(11,101),
(22,102),
(11,103),
(33,104),
...
INSERT INTO CUSTOMER2(CID,CUSTOMER_NAME,CUSTOMER_STREET,CUSTOMER_CITY) VALUES
(11,'CUST1','S1','CITY1'),
(22,'CUST2','S2','CITY2'),
(33,'CUST3','S3','CITY3'),
(44,'CUST4','S4','CITY4'),
